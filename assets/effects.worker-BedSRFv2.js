(function(){"use strict";const D=e=>i(e,e),i=(e,t)=>typeof e=="object"&&e!==null?{x:e.x||0,y:e.y||0}:{x:e||0,y:t||0},f=e=>typeof e=="object"&&e?i(e):D(e),d=(...e)=>e.map(f).reduce((t,o)=>i(t.x+o.x,t.y+o.y)),y=(...e)=>e.map(f).reduce((t,o)=>i(t.x*o.x,t.y*o.y)),p=(e,t)=>d(e,y(t,-1)),T=(e,t)=>{let o=f(e),n=f(t);return i(o.x/n.x,o.y/n.y)},C=e=>{let t=f(e);return Math.sqrt(t.x**2+t.y**2)},L=e=>T(e,C(e));i(0,0),i(1,1);const M=e=>t=>t[e.type]?t[e.type](e.data):t._(),b=(e=1)=>Math.round(Math.random()*e),m=(e=1)=>Math.random()*e,B=(e,t)=>Math.random()>.5?e:t,S=(e,t,o)=>Math.min(Math.max(e,t),o),v=(e,t,o)=>e+(t-e)*o;class F{texture=0;position=i();opacity=1;NodeIndex=0;NodePercent=0;Distance=0;Sine=0;constructor(){let t=m(1);this.NodeIndex=b(h-1),this.NodePercent=m(1),this.Distance=4+t*20,this.Sine=m(Math.PI*2),this.texture=Math.floor(S(0,Math.pow(1-t,3)*4,3)),this.opacity=v(.6,0,t*.5)}}const h=15,R=e=>{let t=[],o=m(e.y),n=0;for(;h>n;)n++,t.push(o),o+=B(-1,1)*(32+m(24*(e.y/360)*2));for(let r=0;r<4;r++)t[t.length-1-r]=v(t[t.length-1-r],t[0],S(0,1-r/4,1));return t},I=i(320,180);class O{stars=[];yNodes=R(I);color="#ffffff";flowSpeed=1;stepSize=32;constructor(){this.stars=Array(128).fill(0).map(()=>new F)}resize(t=I){return this.yNodes=R(t),this.stepSize=t.x/10,this}update(t=1){for(let o of this.stars){let n=this.targetOfStar(o);o.Sine+=t*this.flowSpeed,o.NodePercent+=t*.25*this.flowSpeed,o.NodePercent>=1&&(o.NodePercent-=1,o.NodeIndex++,o.NodeIndex>=h-1&&(o.NodeIndex=0,o.position.x=0)),o.position=d(o.position,T(p(n,o.position),i(50,50)))}}targetOfStar(t){let o={x:t.NodeIndex*this.stepSize,y:this.yNodes[t.NodeIndex]},n={x:(t.NodeIndex+1)*this.stepSize,y:this.yNodes[t.NodeIndex+1]},r=d(o,y(p(n,o),i(t.NodePercent))),a=L(p(n,o));return{x:r.x+-a.x*t.Distance*Math.sin(t.Sine),y:r.y+a.y*t.Distance*Math.sin(t.Sine)}}static ScreenPosOfStar(t,o=i(448,212)){const n=(a,s)=>i(a.x%s.x,a.y%s.y),r=(a,s)=>n(d(n(a,s),s),s);return p(d(i(-64,-16),r(t.position,o)),16)}}var z=`attribute vec2 a_position;
